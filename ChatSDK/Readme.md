...
```gradle
dependencies {
    implementation 'com.github.tellotalksdk:tellotalksdk_corporate_chat:3.9.13'
}
```
...
[Version 3.9.13](https://github.com/TelloTalk/AndroidSDKs/blob/main/ChatSDK/3.9.13.aar)
